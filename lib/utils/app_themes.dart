...
class AppThemes {
  ...
  final IconData goIcon = LocalizeAndTranslate.getLanguageCode() == 'ar'
      ? Ionicons.chevron_back
      : Ionicons.chevron_forward;

  static const primaryColor = Color(0xffdab45e);
  static const mainColor = Color(0xffdab45e);
  ...
  static ThemeData lightTheme() {
    return ThemeData(
      ...
      fontFamily:
          LocalizeAndTranslate.getLanguageCode() == 'ar' ? 'Cairo' : 'Poppins',
